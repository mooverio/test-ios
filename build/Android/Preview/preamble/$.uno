...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.225"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "/Users/rolf.valstad/Dropbox (Making Waves)/moover/dev/test-ios-navigasjon/test-ios.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("test-ios");
}
}
}
