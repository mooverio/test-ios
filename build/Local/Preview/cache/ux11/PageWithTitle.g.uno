...
public partial class PageWithTitle: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp_Value_inst = new testios_FuseControlsTextControl_Value_Property(temp, __selector0);
        this_Title_inst = new testios_FuseControlsPage_Title_Property(this, __selector1);
        temp_TextColor_inst = new testios_FuseControlsTextControl_TextColor_Property(temp, __selector2);
        this_HeaderTextColor_inst = new testios_PageWithTitle_HeaderTextColor_Property(this, __selector3);
        var temp1 = new Fuse.Controls.Panel();
        temp1_Color_inst = new testios_FuseControlsPanel_Color_Property(temp1, __selector4);
        this_HeaderColor_inst = new testios_PageWithTitle_HeaderColor_Property(this, __selector5);
        var temp2 = new Fuse.Controls.Text();
        temp2_Value_inst = new testios_FuseControlsTextControl_Value_Property(temp2, __selector0);
        this_Instructions_inst = new testios_PageWithTitle_Instructions_Property(this, __selector6);
