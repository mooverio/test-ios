...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp28 = new Fuse.Gestures.WhilePressed();
        ...
        var temp33 = new Fuse.Animations.Scale();
        temp_eb0 = new Fuse.Reactive.EventBinding("loginClicked");
        temp16.LineNumber = 2;
        ...
        temp24.Value = "Deliveries reimagined. Move the world with Moover";
        temp24.FontSize = 20f;
        temp24.TextAlignment = Fuse.Controls.TextAlignment.Center;
        temp24.TextColor = Fuse.Drawing.Colors.White;
        temp25.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../background.jpg"));
        temp26.Color = Fuse.Drawing.Colors.Black;
        ...
        temp29.Factor = -1f;
        temp30.Color = float4(0.1803922f, 0.8f, 0.4431373f, 1f);
        temp30.Width = new Uno.UX.Size(50f, Uno.UX.Unit.Percent);
        temp30.Height = new Uno.UX.Size(10f, Uno.UX.Unit.Percent);
