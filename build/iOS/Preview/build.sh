#!/bin/bash
# This file was generated based on '/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/UnoCore/0.45.1/targets/ios/build.sh'.
...
##else
    xcodebuild -project "test-ios.xcodeproj" "$@" | tee >(checkForError)
##endif
