...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Animations/0.45.5/$.uno
// -----------------------------------------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Animations/0.45.5/$.uno");
...
void Attractor::Motion(::g::Fuse::Motion::DestinationMotion* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[1/*"Motion shou...*/], this, ::STRINGS[2/*"/Users/rolf...*/], 201, ::STRINGS[3/*"set_Motion"*/]);
}
...
void ContinuousTrackChangeState__SeekValue_fn(ContinuousTrackChangeState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[2/*"/Users/rolf...*/], 686);
        return;
    }
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[2/*"/Users/rolf...*/], 980);
...
void DiscreteTrackChangeState__SeekObjectValue_fn(DiscreteTrackChangeState* __this, uObject* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[2/*"/Users/rolf...*/], 653);
        return;
    }
...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"Attempt to ...*/], this, ::STRINGS[2/*"/Users/rolf...*/], 1615, ::STRINGS[9/*"Register"*/]);
        return;
    }
...
void MasterProperty::GiveOriginSetterWarning()
{
    ...
    {
        _warningGiven = true;
        ::g::Fuse::Diagnostics::UserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[10/*"The property "*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(Property)->Name())), ::STRINGS[11/*" of "*/]), uPtr(Property)->Object()), ::STRINGS[12/*" cannot be ...*/]), this, ::STRINGS[2/*"/Users/rolf...*/], 1772, ::STRINGS[13/*"GiveOriginS...*/]);
    }
}
// }
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    if (__this->Master == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[14/*"invalid Mix...*/], 1, ::STRINGS[2/*"/Users/rolf...*/], 1888);
        return;
    }
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Resize star...*/], r, ::STRINGS[2/*"/Users/rolf...*/], 2733, ::STRINGS[18/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[19/*"Resize star...*/], r, ::STRINGS[2/*"/Users/rolf...*/], 2741, ::STRINGS[18/*".ctor"*/]);
        _valid = false;
        return;
    }
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[2/*"/Users/rolf...*/], 2882);
        return *__retval = true, void();
    }
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[2/*"/Users/rolf...*/], 3652);
        return;
    }
