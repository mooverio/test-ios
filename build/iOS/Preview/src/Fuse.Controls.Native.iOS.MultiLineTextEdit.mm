...
// private void Fuse.Controls.Native.ITextEdit.set_IsMultiline(bool value) :3096
...
// private static void SetIsMultiline(ObjC.Object handle, bool isMultiline) :3232
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.MultiLineTextEdit", "set_Size(float2)");
...
::g::ObjC::Object* MultiLineTextEdit::CreateDelegate(::g::ObjC::Object* handle, uDelegate* callback, uDelegate* didBeginEditingCallback)
{
    @autoreleasepool
    {
        ...
        {
            return __delegateRef == nil ? nil : [[^ void (::id arg)
            {
        ...
        {
            return __delegateRef == nil ? nil : [[^ void ()
            {
                ::uForeignPool __foreignPool;
                uDelegate* __unoDelegate = (uDelegate*)__delegateRef.unoObject;
...
// private static void SetIsMultiline(ObjC.Object handle, bool isMultiline) [static] :3232
