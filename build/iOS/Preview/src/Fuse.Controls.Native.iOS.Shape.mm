...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.45.5/ios/$.uno");
...
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, ::g::ObjC::Object* path, bool isLine, float strokeWidth)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/Users/rolf...*/], 2209, ::STRINGS[2/*"SetBrush"*/]);
