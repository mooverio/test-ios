...
// public sealed extern class Slider :2392
// {
...
// public Slider(Fuse.Controls.Native.IRangeViewHost host) :2404
void Slider__ctor_2_fn(Slider* __this, uObject* host)
{
    __this->ctor_2(host);
}

// private static ObjC.Object Create() :2419
void Slider__Create_fn(::g::ObjC::Object** __retval)
{
    *__retval = Slider::Create();
}

// public override sealed void Dispose() :2410
...
// private static float GetValue(ObjC.Object handle) :2439
void Slider__GetValue_fn(::g::ObjC::Object* handle, float* __retval)
{
    *__retval = Slider::GetValue(handle);
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host) :2404
void Slider__New1_fn(uObject* host, Slider** __retval)
{
    *__retval = Slider::New1(host);
}

// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) :2427
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :2427
...
// public void set_Progress(double value) [instance] :2397
void Slider::Progress(double value)
{
    Value((float)value * 100.0f);
}

// private float get_Value() [instance] :2434
float Slider::Value()
{
    return Slider::GetValue(Handle());
}

// private void set_Value(float value) [instance] :2435
void Slider::Value(float value)
{
    Slider::SetValue(Handle(), value);
}

// private static ObjC.Object Create() [static] :2419
...
// private static float GetValue(ObjC.Object handle) [static] :2439
...
// public Slider New(Fuse.Controls.Native.IRangeViewHost host) [static] :2404
...
// private static void SetValue(ObjC.Object handle, float value) [static] :2446
