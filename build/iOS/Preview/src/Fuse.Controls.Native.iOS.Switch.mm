...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :2485
void Switch__ctor_2_fn(Switch* __this, uObject* host)
{
    __this->ctor_2(host);
}

// private static ObjC.Object Create() :2505
void Switch__Create_fn(::g::ObjC::Object** __retval)
{
    *__retval = Switch::Create();
}

// public override sealed void Dispose() :2491
...
// private static bool GetValue(ObjC.Object handle) :2511
void Switch__GetValue_fn(::g::ObjC::Object* handle, bool* __retval)
{
    *__retval = Switch::GetValue(handle);
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) :2485
void Switch__New1_fn(uObject* host, Switch** __retval)
{
    *__retval = Switch::New1(host);
}

// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) :2499
...
// private static void SetValue(ObjC.Object handle, bool value) :2518
void Switch__SetValue_fn(::g::ObjC::Object* handle, bool* value)
{
    Switch::SetValue(handle, *value);
}

// public void set_Value(bool value) :2478
void Switch__set_Value_fn(Switch* __this, bool* value)
{
    __this->Value(*value);
}

// public Switch(Fuse.Controls.Native.IToggleViewHost host) [instance] :2485
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :2499
...
// public void set_Value(bool value) [instance] :2478
void Switch::Value(bool value)
{
    Switch::SetValue(Handle(), value);
}

// private static ObjC.Object Create() [static] :2505
...
// private static bool GetValue(ObjC.Object handle) [static] :2511
...
// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :2485
...
// private static void SetValue(ObjC.Object handle, bool value) [static] :2518
