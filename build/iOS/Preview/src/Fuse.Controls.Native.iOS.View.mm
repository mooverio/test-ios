...
{
    ::STRINGS[0] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.45.5/ios/$.uno");
...
// public void BringToFront() :3617
void View__BringToFront_fn(View* __this)
{
    __this->BringToFront();
}

// private static void BringToFront(ObjC.Object handle) :3624
void View__BringToFront1_fn(::g::ObjC::Object* handle)
{
...
// public void set_IsEnabled(bool value) :3652
...
// public void set_Position(float2 value) :3576
...
// public static void SetFrame(ObjC.Object handle, float x, float y, float w, float h) :3696
void View__SetFrame_fn(::g::ObjC::Object* handle, float* x, float* y, float* w, float* h)
{
...
void View::Background(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (value != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::g::Uno::Object::ToString(this), value, ::STRINGS[0/*"/Users/rolf...*/], 3568, ::STRINGS[1/*"set_Backgro...*/]);
    }

    View::SetBackground(Handle(), c.X, c.Y, c.Z, c.W);
}

// public void BringToFront() [instance] :3617
...
// public void set_IsEnabled(bool value) [instance] :3652
...
// public void set_Position(float2 value) [instance] :3576
...
// private static void BringToFront(ObjC.Object handle) [static] :3624
void View::BringToFront1(::g::ObjC::Object* handle)
{
    @autoreleasepool
    {
        [] (::id handle) -> void
...
// public static void SetFrame(ObjC.Object handle, float x, float y, float w, float h) [static] :3696
void View::SetFrame(::g::ObjC::Object* handle, float x, float y, float w, float h)
{
    @autoreleasepool
    {
        [] (::id handle, float x, float y, float w, float h) -> void
