...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Video/0.45.5/$.uno
// ---------------------------------------------------------------------------------------------------
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Video/0.45.5/$.uno");
...
void VideoDiskCache::OnTerminating(int newState)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uString*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(VideoDiskCache::_files()), &ret4), ret4); enum1.MoveNext(::TYPES[15/*Uno.Collections.Dictionary<string, string>.Enumerator*/]); )
    {
        ...
        {
            ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[16/*Uno.Collections.KeyValuePair<string, string>*/])), 1, ::STRINGS[3/*"/Users/rolf...*/], 906);
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[5/*"Video error"*/], e, __this, ::STRINGS[3/*"/Users/rolf...*/], 1077, ::STRINGS[6/*"Fuse.Contro...*/]);
}
...
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[8/*"IPlayback.P...*/], __this, ::STRINGS[3/*"/Users/rolf...*/], 1125, ::STRINGS[9/*"Fuse.Trigge...*/]);
}
