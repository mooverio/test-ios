...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Effects/0.45.5/$.uno
// --------------------------------------------------------------------------------------------
...
// private sealed class DropShadow.Blitter :355
// {
...
// public generated Blitter() :355
void DropShadow__Blitter__ctor__fn(DropShadow__Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Elements.Element element, Uno.Rect elementRect, float padding, int2 tempSize, texture2D blurTexture, float spreadScale, float2 offset, float4 color) :363
...
// public generated Blitter() [instance] :355
void DropShadow__Blitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Elements.Element element, Uno.Rect elementRect, float padding, int2 tempSize, texture2D blurTexture, float spreadScale, float2 offset, float4 color) [instance] :363
...
// private generated void init_DrawCalls() [instance] :355
...
// public generated Blitter New() [static] :355
...
// public static Fuse.Effects.DropShadow.Blitter get_Instance() [static] :360
...
// public override sealed Fuse.VisualBounds ModifyRenderBounds(Fuse.VisualBounds inBounds) :87
...
// protected override sealed void OnRender(Fuse.DrawContext dc, Uno.Rect elementRect) :95
...
// internal float get_Padding() [instance] :93
float Blur::Padding()
{
...
// internal float get_Sigma() [instance] :92
float Blur::Sigma()
{
...
// protected override sealed void OnRender(Fuse.DrawContext dc, Uno.Rect elementRect) :161
...
// public float get_Amount() [instance] :150
float Desaturate::Amount()
{
    return _amount;
}

// public void set_Amount(float value) [instance] :151
...
// public sealed class DropShadow :198
// {
...
// public float get_Angle() [instance] :226
float DropShadow::Angle()
{
    return _angle;
}

// public void set_Angle(float value) [instance] :227
...
// public float4 get_Color() [instance] :296
::g::Uno::Float4 DropShadow::Color()
{
    return _color;
}

// public void set_Color(float4 value) [instance] :300
...
// public float get_Distance() [instance] :246
float DropShadow::Distance()
{
    return _distance;
}

// public void set_Distance(float value) [instance] :247
...
// private float2 get_Offset() [instance] :264
...
// internal float get_Padding() [instance] :315
...
// private float get_Radius() [instance] :220
float DropShadow::Radius()
{
    return Size() / 2.0f;
}

// internal float get_Sigma() [instance] :314
float DropShadow::Sigma()
{
    return ::g::Uno::Math::Max1(Radius(), 1e-05f);
}

// public float get_Size() [instance] :204
float DropShadow::Size()
{
    return _size;
}

// public void set_Size(float value) [instance] :205
...
// public float get_Spread() [instance] :275
float DropShadow::Spread()
{
    return _spread;
}

// public void set_Spread(float value) [instance] :276
...
// public DropShadow New() [static] :347
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.45.5/effects/$.uno
// -----------------------------------------------------------------------------------------------------
...
// internal partial sealed class EffectHelpers :392
// {
...
// public generated EffectHelpers() :392
void EffectHelpers__ctor__fn(EffectHelpers* __this)
{
    __this->ctor_();
}

// public framebuffer Blur(texture2D original, Fuse.DrawContext dc, float sigma) :400
...
// private framebuffer BlurHorizontal(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) :539
...
// private framebuffer BlurVertical(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) :551
...
// private void GaussianBlurSeparable(texture2D tex, float2 dir, float sigma, int samples) :563
...
// private generated void init_DrawCalls() :392
void EffectHelpers__init_DrawCalls_fn(EffectHelpers* __this)
{
    __this->init_DrawCalls();
}

// public static Fuse.Effects.EffectHelpers get_Instance() :397
void EffectHelpers__get_Instance_fn(EffectHelpers** __retval)
{
    *__retval = EffectHelpers::Instance();
}

// public generated EffectHelpers New() :392
void EffectHelpers__New1_fn(EffectHelpers** __retval)
{
    *__retval = EffectHelpers::New1();
}

// private framebuffer ResampleGaussian5tap(Fuse.DrawContext dc, texture2D tex, int2 size) :450
...
// public generated EffectHelpers() [instance] :392
void EffectHelpers::ctor_()
{
    init_DrawCalls();
}

// public framebuffer Blur(texture2D original, Fuse.DrawContext dc, float sigma) [instance] :400
...
// private framebuffer BlurHorizontal(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) [instance] :539
...
// private framebuffer BlurVertical(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) [instance] :551
...
// private void GaussianBlurSeparable(texture2D tex, float2 dir, float sigma, int samples) [instance] :563
...
// private generated void init_DrawCalls() [instance] :392
...
// private framebuffer ResampleGaussian5tap(Fuse.DrawContext dc, texture2D tex, int2 size) [instance] :450
...
// public generated EffectHelpers New() [static] :392
...
// public static Fuse.Effects.EffectHelpers get_Instance() [static] :397
...
// public sealed class Halftone :624
// {
...
// public float get_DotTint() [instance] :679
float Halftone::DotTint()
{
    return _dotTint;
}

// public void set_DotTint(float value) [instance] :680
...
// private generated void init_DrawCalls() [instance] :624
...
// public float get_Intensity() [instance] :649
float Halftone::Intensity()
{
    return _intensity;
}

// public void set_Intensity(float value) [instance] :650
...
// public float get_PaperTint() [instance] :694
float Halftone::PaperTint()
{
    return _paperTint;
}

// public void set_PaperTint(float value) [instance] :695
...
// public float get_Smoothness() [instance] :664
float Halftone::Smoothness()
{
    return _smoothness;
}

// public void set_Smoothness(float value) [instance] :665
...
// public float get_Spacing() [instance] :634
float Halftone::Spacing()
{
    return _spacing;
}

// public void set_Spacing(float value) [instance] :635
...
// public Halftone New() [static] :626
...
// public Uno.UX.FileSource get_File() :907
void Mask__get_File_fn(Mask* __this, ::g::Uno::UX::FileSource** __retval)
{
    *__retval = __this->File();
}

// public void set_File(Uno.UX.FileSource value) :908
void Mask__set_File_fn(Mask* __this, ::g::Uno::UX::FileSource* value)
{
    __this->File(value);
}

// private void Fuse.Internal.IImageContainerOwner.OnParamChanged() :785
...
// private void Fuse.Internal.IImageContainerOwner.OnSizingChanged() :790
...
// private void Fuse.Internal.IImageContainerOwner.OnSourceChanged() :780
...
// private generated void init_DrawCalls() :768
void Mask__init_DrawCalls_fn(Mask* __this)
{
    __this->init_DrawCalls();
}

// public Fuse.Effects.Mask.MaskMode get_Mode() :810
void Mask__get_Mode_fn(Mask* __this, int* __retval)
{
    *__retval = __this->Mode();
}

// public void set_Mode(Fuse.Effects.Mask.MaskMode value) :811
void Mask__set_Mode_fn(Mask* __this, int* value)
{
    __this->Mode(*value);
}

// public override sealed Fuse.VisualBounds ModifyRenderBounds(Fuse.VisualBounds inBounds) :821
...
// protected override sealed void OnRender(Fuse.DrawContext dc, Uno.Rect elementRect) :827
...
// public Uno.UX.FileSource get_File() [instance] :907
...
// public void set_File(Uno.UX.FileSource value) [instance] :908
...
// private generated void init_DrawCalls() [instance] :768
...
// public Fuse.Effects.Mask.MaskMode get_Mode() [instance] :810
int Mask::Mode()
{
    return _mode;
}

// public void set_Mode(Fuse.Effects.Mask.MaskMode value) [instance] :811
...
// public Fuse.Resources.ImageSource get_Source() [instance] :915
...
// public void set_Source(Fuse.Resources.ImageSource value) [instance] :916
