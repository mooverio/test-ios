...
static void Swiper_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.45.5/internal/$.uno");
...
void Swiper::CheckNeedUpdated(bool off)
{
    ...
    for (int i = 0; i < uPtr(_regions)->Count(); ++i)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"incomplete ...*/], this, ::STRINGS[1/*"/Users/rolf...*/], 1013, ::STRINGS[2/*"CheckNeedUp...*/]);
...
bool SwipeRegion::SetProgress(double value, int flags)
{
    ...
    if (endProgress)
    {
        if (!((_progress == 1.0) || (_progress == 0.0)))
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[6/*"Unexpected ...*/], this, ::STRINGS[1/*"/Users/rolf...*/], 748, ::STRINGS[7/*"SetProgress"*/]);
