...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.45.5/rangecontrols/$.uno
// ----------------------------------------------------------------------------------------------------------------------
...
static void CircularRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.45.5/rangecontrols/$.uno");
...
void CircularRangeBehavior__OnRooted_fn(CircularRangeBehavior* __this)
{
    ...
    if ((__this->_rangeControl == NULL) && (__this->_binaryRangeControl == NULL))
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[2/*"RangeContro...*/], __this->Parent(), __this, ::STRINGS[3/*"/Users/rolf...*/], 137, ::STRINGS[4/*"OnRooted"*/]);
    else
    {
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.45.5/$.uno
// ---------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.45.5/internal/$.uno
// ------------------------------------------------------------------------------------------------------
...
void LinearRangeBehavior__OnRooted_fn(LinearRangeBehavior* __this)
{
    ...
    if (__this->Control == NULL)
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[6/*"RangeControl"*/], __this->Parent(), __this, ::STRINGS[3/*"/Users/rolf...*/], 418, ::STRINGS[4/*"OnRooted"*/]);
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.45.5/$.uno
// --------------------------------------------------------------------------------------------------------
...
static void ScrollableGoto_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.45.5/$.uno");
...
{
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[7/*"Use ScrollT...*/], this, ::STRINGS[8/*"/Users/rolf...*/], 112, ::STRINGS[9/*".ctor"*/]);
}
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.45.5/$.uno");
    ::STRINGS[4] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[13/*"Element"*/], __this->Parent(), __this, ::STRINGS[14/*"/Users/rolf...*/], 1019, ::STRINGS[4/*"OnRooted"*/]);
        return;
    }
