...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/FuseCore/0.45.5/input/$.uno
// ----------------------------------------------------------------------------------------------
...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/FuseCore/0.45.5/input/$.uno");
...
bool Pointer::HardCapture(int pointIndex, ::g::Fuse::Visual* node, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"HardCapture...*/], 1, ::STRINGS[9/*"/Users/rolf...*/], 1191);
        return false;
    }
...
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Visual* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[13/*"SoftCapture...*/], 1, ::STRINGS[9/*"/Users/rolf...*/], 1100);
        return false;
    }
