...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/FuseCore/0.45.5/internal/$.uno
// -------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.45.5/internal/$.uno
// ------------------------------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.45.5/internal/$.uno");
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[2/*"ResampleMod...*/], this, ::STRINGS[3/*"/Users/rolf...*/], 254, ::STRINGS[4/*"set_Resampl...*/]);
