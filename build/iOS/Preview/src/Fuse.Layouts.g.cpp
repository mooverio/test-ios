...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/0.45.5/layouts/$.uno
// ------------------------------------------------------------------------------------------------------------
...
static void GridLayout_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/0.45.5/layouts/$.uno");
...
void GridLayout::ModifyCount(uType* __type, uObject* list, int count, ::g::Fuse::Layouts::DefinitionBase* primordial)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"RowCount an...*/], this, ::STRINGS[6/*"/Users/rolf...*/], 1116, ::STRINGS[7/*"ModifyCount"*/]);
        return;
    }
