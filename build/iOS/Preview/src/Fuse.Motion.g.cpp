...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Motion/0.45.5/$.uno
// -------------------------------------------------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Motion/0.45.5/$.uno");
...
uObject* DestinationMotion::Create()
{
    ...
    switch (Type())
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"/Users/rolf...*/], 398, ::STRINGS[2/*"Create"*/]);
