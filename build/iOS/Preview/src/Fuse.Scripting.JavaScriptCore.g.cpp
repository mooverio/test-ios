...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Scripting.JavaScriptCore/0.45.5/$.uno
// -------------------------------------------------------------------------------------------------------------
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Scripting.JavaScriptCore/0.45.5/$.uno");
...
::JSObjectRef JSValueRef::GetJSObjectRef(::JSValueRef __this, ::JSContextRef ctx)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JSValueRef::IsObject(__this, ctx), ::STRINGS[23/*"(&this).IsO...*/], ::STRINGS[24/*"/Users/rolf...*/], 476, uArray::Init<uObject*>(::TYPES[16/*object[]*/], 1, uBox(::g::Fuse::Scripting::JavaScriptCore::JSContextRef_typeof(), ctx)));
