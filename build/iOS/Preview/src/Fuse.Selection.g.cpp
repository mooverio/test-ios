...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Selection/0.45.5/$.uno
// ----------------------------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Selection/0.45.5/$.uno");
...
void Selectable__OnRooted_fn(Selectable* __this)
{
    ...
    if (__this->_selection == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/rolf...*/], 116, ::STRINGS[9/*"OnRooted"*/]);
}
...
void Selectable::Add1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/rolf...*/], 157, ::STRINGS[7/*"Add"*/]);
        return;
    }
...
void Selectable::Remove1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/rolf...*/], 171, ::STRINGS[11/*"Remove"*/]);
        return;
    }
...
void Selectable::Toggle()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/rolf...*/], 185, ::STRINGS[13/*"Toggle"*/]);
        return;
    }
...
void Selectable::add(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"add require...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 30, ::STRINGS[1/*"add"*/]);
        return;
    }
...
void Selectable::remove(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"remove requ...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 48, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
void Selectable::toggle(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"toggle requ...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 64, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, ::STRINGS[5/*"/Users/rolf...*/], 890, ::STRINGS[21/*"Fuse.Script...*/]);
}
...
void Selection__FuseScriptingIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/rolf...*/], 880, ::STRINGS[23/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/rolf...*/], 845, ::STRINGS[24/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/rolf...*/], 869, ::STRINGS[25/*"Fuse.Script...*/]);
        return;
    }
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"MaxCount mu...*/], this, ::STRINGS[5/*"/Users/rolf...*/], 553, ::STRINGS[29/*"set_MaxCount"*/]);
        return;
    }
...
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"`Values` mu...*/], this, ::STRINGS[5/*"/Users/rolf...*/], 796, ::STRINGS[32/*"set_Values"*/]);
        return;
    }
...
void Selection::add(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"add require...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 342, ::STRINGS[1/*"add"*/]);
        return;
    }
...
void Selection::clear(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"clear requi...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 324, ::STRINGS[14/*"clear"*/]);
        return;
    }
...
void Selection::forceAdd(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"forceAdd re...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 374, ::STRINGS[15/*"forceAdd"*/]);
        return;
    }
...
void Selection::forceRemove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"forceRemove...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 388, ::STRINGS[16/*"forceRemove"*/]);
        return;
    }
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"remove requ...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 360, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[27/*"toggle requ...*/], s, ::STRINGS[5/*"/Users/rolf...*/], 404, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/rolf...*/], 237, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/rolf...*/], 954, ::STRINGS[36/*"Perform"*/]);
        return;
    }
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/rolf...*/], 1003, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
