// This file was generated based on '/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Text/0.45.5/implementation/$.uno'.
...
static void CoreTextFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Text/0.45.5/implementation/$.uno");
...
uArray* CoreTextFont::TryConvertRGBAToL8(uArray* buffer)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == 0, ::STRINGS[0/*"(buffer.Len...*/], ::STRINGS[1/*"/Users/rolf...*/], 220, uArray::Init<uObject*>(::TYPES[0/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
