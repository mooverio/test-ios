...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.45.5/triggers/actions/$.uno
// --------------------------------------------------------------------------------------------------------------
...
// public sealed class EvaluateJS :922
// {
...
// private string PrepareScriptForEval(string js) :943
...
// public generated void add_Handler(Fuse.Triggers.Actions.JSEventHandler value) [instance] :928
...
// public generated void remove_Handler(Fuse.Triggers.Actions.JSEventHandler value) [instance] :928
...
// public string get_JavaScript() [instance] :938
uString* EvaluateJS::JavaScript()
{
    return _processedSource;
}

// public void set_JavaScript(string value) [instance] :939
...
// private string PrepareScriptForEval(string js) [instance] :943
...
// private void ResultHandler(string result) [instance] :971
...
// public Fuse.Controls.IWebView get_WebView() [instance] :931
uObject* EvaluateJS::WebView()
{
    return _target;
}

// public void set_WebView(Fuse.Controls.IWebView value) [instance] :932
void EvaluateJS::WebView(uObject* value)
{
    _target = value;
}

// public generated EvaluateJS New() [static] :922
...
// public sealed class JSEventArgs :827
// {
...
// public JSEventArgs(string resultJson) :830
void JSEventArgs__ctor_1_fn(JSEventArgs* __this, uString* resultJson)
{
    __this->ctor_1(resultJson);
}

// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :835
...
// public JSEventArgs New(string resultJson) [static] :830
...
// public delegate void JSEventHandler(object sender, Fuse.Triggers.Actions.JSEventArgs args) :841
...
// public sealed class LoadHtml :719
// {
...
// public generated string get_Source() [instance] :723
uString* LoadHtml::Source()
{
    return _Source;
}

// public generated void set_Source(string value) [instance] :723
void LoadHtml::Source(uString* value)
{
    _Source = value;
}

// public generated LoadHtml New() [static] :719
...
// public sealed class LoadUrl :677
// {
...
// public generated LoadUrl() :677
void LoadUrl__ctor_3_fn(LoadUrl* __this)
{
    __this->ctor_3();
}

// private override sealed void Execute(Fuse.Controls.WebView webview) :682
...
// public generated LoadUrl New() :677
void LoadUrl__New2_fn(LoadUrl** __retval)
{
    *__retval = LoadUrl::New2();
}

// public generated string get_Url() :680
void LoadUrl__get_Url_fn(LoadUrl* __this, uString** __retval)
{
    *__retval = __this->Url();
}

// public generated void set_Url(string value) :680
void LoadUrl__set_Url_fn(LoadUrl* __this, uString* value)
{
    __this->Url(value);
}

// public generated LoadUrl() [instance] :677
void LoadUrl::ctor_3()
{
    ctor_2();
}

// public generated string get_Url() [instance] :680
uString* LoadUrl::Url()
{
    return _Url;
}

// public generated void set_Url(string value) [instance] :680
void LoadUrl::Url(uString* value)
{
    _Url = value;
}

// public generated LoadUrl New() [static] :677
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.45.5/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[7/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[8/*"/Users/rolf...*/], 240, ::STRINGS[9/*"Perform"*/]);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.45.5/$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Requires a ...*/], __this, ::STRINGS[11/*"/Users/rolf...*/], 283, ::STRINGS[9/*"Perform"*/]);
        return;
    }
...
// public sealed class Reload :653
// {
...
// public generated Reload() :653
void Reload__ctor_3_fn(Reload* __this)
{
    __this->ctor_3();
}

// private override sealed void Execute(Fuse.Controls.WebView webview) :655
...
// public generated Reload New() :653
void Reload__New2_fn(Reload** __retval)
{
    *__retval = Reload::New2();
}

// public generated Reload() [instance] :653
void Reload::ctor_3()
{
    ctor_2();
}

// public generated Reload New() [static] :653
Reload* Reload::New2()
{
...
// public sealed class StopLoading :665
// {
...
// public generated StopLoading() :665
void StopLoading__ctor_3_fn(StopLoading* __this)
{
    __this->ctor_3();
}

// private override sealed void Execute(Fuse.Controls.WebView webview) :667
...
// public generated StopLoading New() :665
void StopLoading__New2_fn(StopLoading** __retval)
{
    *__retval = StopLoading::New2();
}

// public generated StopLoading() [instance] :665
void StopLoading::ctor_3()
{
    ctor_2();
}

// public generated StopLoading New() [static] :665
...
static void TriggerAction_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.45.5/actions/$.uno");
...
{
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[13/*"Use `Trigge...*/], this, ::STRINGS[14/*"/Users/rolf...*/], 852, ::STRINGS[15/*"set_Direction"*/]);
    When(value);
}
...
// public abstract class WebViewNavAction :631
// {
...
// internal WebViewNavAction() :633
void WebViewNavAction__ctor_2_fn(WebViewNavAction* __this)
{
    __this->ctor_2();
}

// protected override sealed void Perform(Fuse.Node target) :635
...
// internal WebViewNavAction() [instance] :633
