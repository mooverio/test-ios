...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.45.5/ios/$.uno
// ---------------------------------------------------------------------------------------------------------
...
static void WebView_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.45.5/ios/$.uno");
...
// public string get_DocumentTitle() :343
...
// public void add_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) :213
void WebView__add_HistoryChanged_fn(WebView* __this, uDelegate* value)
{
    __this->add_HistoryChanged(value);
}

// public void remove_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) :214
...
// public string get_DocumentTitle() [instance] :343
...
// public void add_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) [instance] :213
...
// public void remove_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) [instance] :214
...
void WebView::OnLowMemory()
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[2/*"low mem in ...*/], 1, ::STRINGS[3/*"/Users/rolf...*/], 228);
