...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/FuseJS/0.45.5/$.uno
// --------------------------------------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[55] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/FuseJS/0.45.5/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[54/*"Cannot find...*/], Name), this, ::STRINGS[55/*"/Users/rolf...*/], 889, ::STRINGS[56/*"Raise"*/]);
        return;
    }
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[59/*"The FuseJS/...*/], context, ::STRINGS[55/*"/Users/rolf...*/], 920, ::STRINGS[56/*"Raise"*/]);
