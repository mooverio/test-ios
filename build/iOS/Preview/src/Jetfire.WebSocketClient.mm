// This file was generated based on '/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.WebSockets/0.45.5/ios/jetfire/$.uno'.
...
::g::ObjC::Object* WebSocketClient::Create1(uString* url, uArray* protocols, uDelegate* eventHandler, uDelegate* receiveMessageHandler, uDelegate* receiveDataHandler)
{
    @autoreleasepool
    {
        ...
        {
            return __delegateRef == nil ? nil : [[^ void (::NSString* arg1, ::NSString* arg2)
            {
        ...
        {
            return __delegateRef == nil ? nil : [[^ void (::NSString* arg)
            {
                ::uForeignPool __foreignPool;
                uDelegate* __unoDelegate = (uDelegate*)__delegateRef.unoObject;
        ...
        {
            return __delegateRef == nil ? nil : [[^ void (id<UnoArray> arg)
            {
                ::uForeignPool __foreignPool;
                uDelegate* __unoDelegate = (uDelegate*)__delegateRef.unoObject;
