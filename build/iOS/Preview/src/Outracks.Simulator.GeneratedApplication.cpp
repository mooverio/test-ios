// This file was generated based on /Users/rolf.valstad/Desktop/test-ios/build/iOS/Preview/preamble/$.uno.
...
{
    ::STRINGS[0] = uString::Const("192.168.1.225");
    ::STRINGS[1] = uString::Const("127.0.0.1");
    ::STRINGS[2] = uString::Const("/Users/rolf.valstad/Desktop/test-ios/test-ios.unoproj");
    ::STRINGS[3] = uString::Const("test-ios");
...
void GeneratedApplication::ctor_5()
{
    ...
    ctor_4(uArray::Init< ::g::Uno::Net::IPEndPoint*>(::TYPES[0/*Uno.Net.IPEndPoint[]*/], 2, (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[0/*"192.168.1.225"*/]), 12124), (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[1/*"127.0.0.1"*/]), 12124)), ::STRINGS[2/*"/Users/rolf...*/], uDelegate::New(::TYPES[1/*Uno.Func<Uno.IO.Bundle>*/], (void*)GeneratedApplication__GetBundle_fn), uArray::Init<uString*>(::TYPES[2/*string[]*/], 0));
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[3/*"test-ios"*/]);
}
