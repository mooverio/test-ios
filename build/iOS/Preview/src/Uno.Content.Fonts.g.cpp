...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/UnoCore/0.45.1/source/uno/content/fonts/$.uno
// ----------------------------------------------------------------------------------------------------------------
...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/UnoCore/0.45.1/source/uno/content/fonts/$.uno");
    type->SetFields(0,
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[1/*"DefaultText...*/], 1, ::STRINGS[2/*"/Users/rolf...*/], 321);
    return *__retval = __this->_matrix, void();
}
