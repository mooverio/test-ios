...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Uno.Net.Http/0.45.1/uriparsers/$.uno
// -------------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Uno.Net.Http/0.45.1/$.uno
// --------------------------------------------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Uno.Net.Http/0.45.1/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[22/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"/Users/rolf...*/], 17);
    else
...
void HttpMessageCache::MaxCacheSizeInBytes(int64_t value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[24/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"/Users/rolf...*/], 30);
    else
