...
// public static extern class Support :285
// {
...
// public static extern float2 CGPointToUnoFloat2(Uno.Platform.iOS.uCGPoint point, float scale) :287
...
// public static extern Uno.Rect CGRectToUnoRect(Uno.Platform.iOS.uCGRect rect, float scale) :303
void Support__CGRectToUnoRect_fn(CGRect* rect, float* scale, ::g::Uno::Rect* __retval)
{
    *__retval = Support::CGRectToUnoRect(*rect, *scale);
}

// public static extern float2 CGSizeToUnoFloat2(Uno.Platform.iOS.uCGSize size, float scale) :295
...
// public static extern Uno.Platform.iOS.uCGRect Pre_iOS8_HandleDeviceOrientation_Rect(Uno.Platform.iOS.uCGRect cgrect, ObjC.Object view) :310
...
// public static extern float2 CGPointToUnoFloat2(Uno.Platform.iOS.uCGPoint point, float scale) [static] :287
...
// public static extern Uno.Rect CGRectToUnoRect(Uno.Platform.iOS.uCGRect rect, float scale) [static] :303
...
// public static extern float2 CGSizeToUnoFloat2(Uno.Platform.iOS.uCGSize size, float scale) [static] :295
...
// public static extern Uno.Platform.iOS.uCGRect Pre_iOS8_HandleDeviceOrientation_Rect(Uno.Platform.iOS.uCGRect cgrect, ObjC.Object view) [static] :310
