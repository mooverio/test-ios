...
static void iOSDisplay_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/rolf.valstad/Library/Application Support/Fusetools/Packages/UnoCore/0.45.1/source/uno/platform/ios/$.uno");
...
void iOSDisplay::ctor_1(::g::ObjC::Object* handle)
{
    ...
    ctor_();
    _handle = handle;
    ::g::Uno::Diagnostics::Debug::Assert(_handle != NULL, ::STRINGS[0/*"this._handl...*/], ::STRINGS[1/*"/Users/rolf...*/], 37, uArray::New(::TYPES[0/*object[]*/], 0));
