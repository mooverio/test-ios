...
static uString* STRINGS[167];
static uType* TYPES[3];

namespace g{

// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Android/0.45.5/.uno/package
// ---------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls/0.45.5/.uno/package
// ----------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.45.5/.uno/package
// -----------------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.45.5/.uno/ux11/$.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/0.45.5/.uno/package
// -----------------------------------------------------------------------------------------------------------
...
{
    FuseControlsPanels_bundle::FreezeDrawable1e2faccf_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[29/*"uniform mat...*/], ::STRINGS[30/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"f"*/]));
}

static void FuseControlsPanels_bundle_build(uType* type)
{
    ::STRINGS[29] = uString::Const("uniform mat4 d, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 e;\n"
        ...
        "}\n"
        "");
    ::STRINGS[30] = uString::Const("uniform float c;\n"
        "\n"
        "uniform sampler2D f;\n"
        "\n"
        "varying vec2 e;\n"
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.45.5/.uno/package
// ---------------------------------------------------------------------------------------------------------------
...
{
    FuseControlsPrimitives_bundle::ImageElementDraw7660063a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[31/*"uniform mat...*/], ::STRINGS[32/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[11/*"h"*/]));
}

static void FuseControlsPrimitives_bundle_build(uType* type)
{
    ::STRINGS[31] = uString::Const("uniform mat4 f, b;\n"
        "uniform vec2 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[32] = uString::Const("uniform vec4 e;\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
        "varying vec2 g;\n"
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.45.5/.uno/ux11/$.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.45.5/.uno/ux11/$.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Controls.Video/0.45.5/.uno/package
// ----------------------------------------------------------------------------------------------------------
...
static void FuseControlsVideo_bundle__cctor__fn(uType* __type)
{
    ...
    FuseControlsVideo_bundle::VideoDrawElement5c829975_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[35/*"uniform mat...*/], ::STRINGS[36/*"uniform sam...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[11/*"h"*/]));
}
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/FuseCore/0.45.5/.uno/package
// -----------------------------------------------------------------------------------------------
...
{
    FuseCore_bundle::DrawHelpers4c5c39ae_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[37/*"uniform vec...*/], ::STRINGS[38/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/]));
}
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Drawing/0.45.5/.uno/package
// ---------------------------------------------------------------------------------------------------
...
{
    FuseDrawing_bundle::LinearGradientDrawable479fd075_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[39/*"attribute v...*/], ::STRINGS[40/*"uniform flo...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/]));
}
...
static void FuseDrawing_bundle_build(uType* type)
{
    ::STRINGS[39] = uString::Const("attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[40] = uString::Const("uniform float d[b], e;\n"
        "uniform vec4 f[c];\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Polygons/0.45.5/.uno/package
// ------------------------------------------------------------------------------------------------------------
...
{
    FuseDrawingPolygons_bundle::Border59574a1c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[41/*"uniform mat...*/], ::STRINGS[42/*"varying vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/]));
    FuseDrawingPolygons_bundle::Border896a8e7a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[43/*"uniform mat...*/], ::STRINGS[44/*"varying vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseDrawingPolygons_bundle::Borderb6afd581_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[45/*"uniform mat...*/], ::STRINGS[46/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[47/*"s"*/]));
    FuseDrawingPolygons_bundle::Borderfbfebeb7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[48/*"uniform mat...*/], ::STRINGS[49/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[14/*"k"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawable13820064_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[50/*"uniform mat...*/], ::STRINGS[25/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawable13820065_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[51/*"uniform mat...*/], ::STRINGS[52/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[13/*"j"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawable13820067_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[53/*"uniform mat...*/], ::STRINGS[54/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[55/*"r"*/]));
}
...
static void FuseDrawingPolygons_bundle_build(uType* type)
{
    ::STRINGS[41] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[42] = uString::Const("varying vec4 e;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = e;\n"
    ...
    ::STRINGS[43] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[44] = uString::Const("varying vec4 d;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = d;\n"
        "}\n"
        "");
    ::STRINGS[45] = uString::Const("uniform mat4 d;\n"
        "uniform vec2 e, f, g, h, i, k, j;\n"
        "\n"
        "attribute vec4 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[46] = uString::Const("uniform vec2 m, l;\n"
        "uniform vec4 n;\n"
        "uniform float o;\n"
        "\n"
        "uniform sampler2D s;\n"
    ...
    ::STRINGS[52] = uString::Const("uniform float f;\n"
        ...
        "}\n"
        "");
    ::STRINGS[53] = uString::Const("uniform mat4 d;\n"
        "uniform vec2 e, f, g, h, i, k, j;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[54] = uString::Const("uniform vec2 m, l;\n"
        "uniform vec4 n;\n"
        "uniform float o;\n"
        "\n"
        "uniform sampler2D r;\n"
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Primitives/0.45.5/.uno/package
// --------------------------------------------------------------------------------------------------------------
...
{
    FuseDrawingPrimitives_bundle::Circle01247f96_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[56/*"uniform vec...*/], ::STRINGS[57/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[58/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle038d0b56_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[59/*"uniform vec...*/], ::STRINGS[60/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 26, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[62/*"w"*/], ::STRINGS[63/*"x"*/], ::STRINGS[64/*"y"*/], ::STRINGS[65/*"C"*/]));
    FuseDrawingPrimitives_bundle::Circle09647386_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[67/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[47/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle09647387_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[68/*"uniform vec...*/], ::STRINGS[69/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[19/*"p"*/]));
    FuseDrawingPrimitives_bundle::Circle09647389_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[70/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[47/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle27c6b7fe_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[56/*"uniform vec...*/], ::STRINGS[71/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[58/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle27c6b7ff_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[72/*"uniform vec...*/], ::STRINGS[73/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[55/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle4a971b16_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[74/*"uniform vec...*/], ::STRINGS[75/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/]));
    FuseDrawingPrimitives_bundle::Circle4c78c62c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[76/*"uniform vec...*/], ::STRINGS[77/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle60e596bb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[59/*"uniform vec...*/], ::STRINGS[78/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 26, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[62/*"w"*/], ::STRINGS[63/*"x"*/], ::STRINGS[64/*"y"*/], ::STRINGS[65/*"C"*/]));
    ...
    FuseDrawingPrimitives_bundle::Circle91c7af62_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[81/*"uniform vec...*/], ::STRINGS[82/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circlebe3e2220_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[83/*"uniform vec...*/], ::STRINGS[84/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[85/*"z"*/]));
    FuseDrawingPrimitives_bundle::Circlecfb305c7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[86/*"uniform vec...*/], ::STRINGS[87/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 24, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[62/*"w"*/], ::STRINGS[88/*"A"*/]));
    FuseDrawingPrimitives_bundle::Circlecfb305c9_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[89/*"uniform vec...*/], ::STRINGS[90/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 21, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[63/*"x"*/]));
    FuseDrawingPrimitives_bundle::Circlecfb305ca_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[86/*"uniform vec...*/], ::STRINGS[91/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 24, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[62/*"w"*/], ::STRINGS[88/*"A"*/]));
    FuseDrawingPrimitives_bundle::Circled0e74ba4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[92/*"uniform vec...*/], ::STRINGS[93/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 10, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/]));
    FuseDrawingPrimitives_bundle::Circled802ead9_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[79/*"uniform vec...*/], ::STRINGS[94/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circlee8f0edda_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[95/*"uniform vec...*/], ::STRINGS[96/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circlee8f0eddb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[95/*"uniform vec...*/], ::STRINGS[97/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circleef203ac7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[76/*"uniform vec...*/], ::STRINGS[98/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/]));
    ...
    FuseDrawingPrimitives_bundle::Circlef28f173d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[81/*"uniform vec...*/], ::STRINGS[101/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circlef28f173e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[81/*"uniform vec...*/], ::STRINGS[102/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectangle5aede5cb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[103/*"uniform flo...*/], ::STRINGS[104/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[21/*"t"*/]));
    FuseDrawingPrimitives_bundle::Rectangle5aede5cc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[103/*"uniform flo...*/], ::STRINGS[105/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[21/*"t"*/]));
    FuseDrawingPrimitives_bundle::Rectangle6bc1d5d3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[106/*"uniform flo...*/], ::STRINGS[107/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/]));
    FuseDrawingPrimitives_bundle::Rectangle6bc1d5d4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[106/*"uniform flo...*/], ::STRINGS[108/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/]));
    FuseDrawingPrimitives_bundle::Rectangle7c95c5e3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[109/*"uniform flo...*/], ::STRINGS[110/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[111/*"B"*/]));
    FuseDrawingPrimitives_bundle::Rectangle7c95c5e4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[109/*"uniform flo...*/], ::STRINGS[112/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[111/*"B"*/]));
    FuseDrawingPrimitives_bundle::Rectangle7fa93ce4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[113/*"uniform flo...*/], ::STRINGS[114/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/]));
    FuseDrawingPrimitives_bundle::Rectangle8d69b5eb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[115/*"uniform flo...*/], ::STRINGS[116/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectangle8d69b5ec_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[115/*"uniform flo...*/], ::STRINGS[117/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f3bc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[113/*"uniform flo...*/], ::STRINGS[118/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f4fc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[119/*"uniform flo...*/], ::STRINGS[120/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 25, ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[62/*"w"*/], ::STRINGS[63/*"x"*/], ::STRINGS[121/*"D"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f503_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[119/*"uniform flo...*/], ::STRINGS[122/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 25, ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[55/*"r"*/], ::STRINGS[47/*"s"*/], ::STRINGS[21/*"t"*/], ::STRINGS[58/*"u"*/], ::STRINGS[61/*"v"*/], ::STRINGS[62/*"w"*/], ::STRINGS[63/*"x"*/], ::STRINGS[121/*"D"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f53c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[123/*"uniform flo...*/], ::STRINGS[124/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f53f_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[123/*"uniform flo...*/], ::STRINGS[125/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f57b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[126/*"uniform flo...*/], ::STRINGS[127/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[61/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f57c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[126/*"uniform flo...*/], ::STRINGS[128/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[20/*"q"*/], ::STRINGS[61/*"v"*/]));
}
...
static void FuseDrawingPrimitives_bundle_build(uType* type)
{
    ...
    ::STRINGS[67] = uString::Const("uniform float h, i, j, k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[68] = uString::Const("uniform vec2 b, c, e, f, g, l;\n"
        "uniform mat4 d;\n"
        "uniform float m;\n"
        "\n"
        "attribute vec2 a;\n"
    ...
    ::STRINGS[71] = uString::Const("uniform float h, i, j, k, l, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[72] = uString::Const("uniform vec2 b, c, e, f, g, n;\n"
        "uniform mat4 d;\n"
        "uniform float o;\n"
        "\n"
        "attribute vec2 a;\n"
    ...
    ::STRINGS[77] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[78] = uString::Const("uniform vec2 o, n, w, x, y;\n"
        "uniform vec4 p;\n"
        "uniform float q, r, s, t, u, v;\n"
        "\n"
        "uniform sampler2D C;\n"
    ...
    ::STRINGS[86] = uString::Const("uniform vec2 d, e, g, h, i, j, k, m, l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[87] = uString::Const("uniform vec2 o, n, u, v, w;\n"
        "uniform vec4 p;\n"
    ...
    ::STRINGS[93] = uString::Const("uniform float e, f, g, h, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[94] = uString::Const("uniform float e, f, g, h, i, j;\n"
        "uniform vec2 l, m, n;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 o;\n"
    ...
    ::STRINGS[101] = uString::Const("uniform float e, f, g, h;\n"
        ...
        "}\n"
        "");
    ::STRINGS[102] = uString::Const("uniform float e, f, g, h;\n"
        "uniform vec2 j, k, l;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[103] = uString::Const("uniform float e[d], o;\n"
    ...
    ::STRINGS[104] = uString::Const("uniform float k, l, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[105] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
    ...
    ::STRINGS[107] = uString::Const("uniform float h, i, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[108] = uString::Const("uniform float h, i, j;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float l;\n"
        "varying vec2 m, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[109] = uString::Const("uniform float g[d];\n"
    ...
    ::STRINGS[113] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[114] = uString::Const("uniform float h, i, j, k, l;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float n;\n"
        "varying vec2 o, p;\n"
    ...
    ::STRINGS[116] = uString::Const("uniform float h, i, j, l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[117] = uString::Const("uniform float h, i, j, l;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float m;\n"
        "varying vec2 n, o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[118] = uString::Const("uniform float h, i, j, k, l;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float n;\n"
        "varying vec2 o, p;\n"
        ...
        "}\n"
        "");
    ::STRINGS[119] = uString::Const("uniform float g[d];\n"
        "uniform vec2 h, j, k, l, m, n, p, o;\n"
        "uniform mat4 i;\n"
        "\n"
        "attribute vec4 a, b;\n"
    ...
    ::STRINGS[122] = uString::Const("uniform vec2 r, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[123] = uString::Const("uniform float e[d];\n"
        "uniform vec2 f;\n"
        "uniform mat4 g;\n"
        "\n"
        "attribute vec4 a, b;\n"
    ...
    ::STRINGS[124] = uString::Const("uniform float h, i, j, k, l, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[125] = uString::Const("uniform float h, i, j, k, l, n;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float o;\n"
        "varying vec2 p, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[126] = uString::Const("uniform float e[d], q;\n"
    ...
    ::STRINGS[127] = uString::Const("uniform float k, l, m, n, o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[128] = uString::Const("uniform float k, l, m, n, o;\n"
        "\n"
        "uniform sampler2D v;\n"
        "\n"
        "varying float r, s;\n"
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Effects/0.45.5/.uno/package
// ---------------------------------------------------------------------------------------------------
...
{
    FuseEffects_bundle::Blitter6e650d31_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[129/*"uniform mat...*/], ::STRINGS[130/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[11/*"h"*/]));
    ...
    FuseEffects_bundle::Desaturate88bb7f94_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[29/*"uniform mat...*/], ::STRINGS[131/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"f"*/]));
    FuseEffects_bundle::EffectHelpers52052d40_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[132/*"attribute v...*/], ::STRINGS[133/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::EffectHelpers9b892494_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[134/*"attribute v...*/], ::STRINGS[135/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/]));
    FuseEffects_bundle::EffectHelpersd8c2e3e5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[136/*"uniform vec...*/], ::STRINGS[137/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[21/*"t"*/]));
    FuseEffects_bundle::EffectHelperse7e608d1_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[138/*"uniform vec...*/], ::STRINGS[139/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[16/*"m"*/]));
    FuseEffects_bundle::Halftone3c4c510c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[140/*"uniform mat...*/], ::STRINGS[141/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[20/*"q"*/]));
    FuseEffects_bundle::Mask0da73af7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[142/*"uniform mat...*/], ::STRINGS[143/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Mask6affc65c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[142/*"uniform mat...*/], ::STRINGS[144/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Maskb04eaf92_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[142/*"uniform mat...*/], ::STRINGS[145/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
}

static void FuseEffects_bundle_build(uType* type)
{
    ::STRINGS[129] = uString::Const("uniform mat4 f, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 g;\n"
        ...
        "}\n"
        "");
    ::STRINGS[130] = uString::Const("uniform vec3 e;\n"
        "uniform float c, d;\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
    ...
    ::STRINGS[29] = uString::Const("uniform mat4 d, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[131] = uString::Const("uniform float c;\n"
        "\n"
        "uniform sampler2D f;\n"
        "\n"
        "varying vec2 e;\n"
    ...
    ::STRINGS[133] = uString::Const("uniform float e[b];\n"
        ...
        "}\n"
        "");
    ::STRINGS[134] = uString::Const("attribute vec2 a;\n"
        "\n"
        "varying vec2 b;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[135] = uString::Const("uniform sampler2D c;\n"
        "\n"
        "varying vec2 b;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[136] = uString::Const("uniform vec2 c, e, f, h, i, j;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[137] = uString::Const("uniform float b, d, g;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying vec2 k, l, m, n, o, p, q, r, s;\n"
    ...
    ::STRINGS[139] = uString::Const("uniform float b, d;\n"
        ...
        "");
    ::STRINGS[16] = uString::Const("m");
    ::STRINGS[140] = uString::Const("uniform mat4 m, b;\n"
        "uniform vec2 g, h;\n"
        "uniform mat2 i;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[141] = uString::Const("uniform float c, d, e, f, k, l;\n"
        "uniform mat2 j;\n"
        "\n"
        "uniform sampler2D q;\n"
        "\n"
    ...
    ::STRINGS[15] = uString::Const("l");
    ::STRINGS[20] = uString::Const("q");
    ::STRINGS[142] = uString::Const("uniform mat4 e, b;\n"
        "uniform vec2 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
    ...
    ::STRINGS[144] = uString::Const("uniform sampler2D h, i;\n"
        ...
        "}\n"
        "");
    ::STRINGS[145] = uString::Const("uniform sampler2D h, i;\n"
        "\n"
        "varying vec2 f, g;\n"
        "\n"
        "void main()\n"
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.45.5/.uno/package
// ----------------------------------------------------------------------------------------------------
...
{
    FuseElements_bundle::CacheHelper230c69b7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[146/*"uniform vec...*/], ::STRINGS[147/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"g"*/]));
    FuseElements_bundle::ElementBatchd43eeb4e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[148/*"uniform mat...*/], ::STRINGS[149/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"f"*/]));
    ...
    FuseElements_bundle::RepeatBaker447c61dc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[150/*"uniform vec...*/], ::STRINGS[151/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"e"*/]));
    FuseElements_bundle::Scale9Rectangle720ad3ad_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[152/*"uniform flo...*/], ::STRINGS[153/*"uniform vec...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"k"*/], ::STRINGS[15/*"l"*/], ::STRINGS[16/*"m"*/], ::STRINGS[17/*"n"*/], ::STRINGS[18/*"o"*/], ::STRINGS[19/*"p"*/], ::STRINGS[55/*"r"*/]));
}

static void FuseElements_bundle_build(uType* type)
{
    ::STRINGS[146] = uString::Const("uniform vec2 b;\n"
        "uniform mat4 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[147] = uString::Const("uniform float e;\n"
        "\n"
        "uniform sampler2D g;\n"
        "\n"
        "varying vec2 f;\n"
    ...
    ::STRINGS[9] = uString::Const("e");
    ::STRINGS[10] = uString::Const("g");
    ::STRINGS[148] = uString::Const("uniform mat4 c;\n"
        "\n"
        "attribute vec3 a;\n"
        "attribute vec2 b;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[149] = uString::Const("uniform sampler2D f;\n"
        "\n"
        "varying float d;\n"
        "varying vec2 e;\n"
        "\n"
    ...
    ::STRINGS[150] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[151] = uString::Const("uniform sampler2D e;\n"
        "\n"
        "varying vec2 d;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[152] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[153] = uString::Const("uniform vec4 p;\n"
        "\n"
        "uniform sampler2D r;\n"
        "\n"
        "varying vec2 q;\n"
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.45.5/.uno/package
// ----------------------------------------------------------------------------------------------------
...
{
    FuseReactive_bundle::Diagnosticsc55470d6_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[154/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[155/*"diagnostics...*/]);
    FuseReactive_bundle::es6promisemin1fdd6b41_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[154/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[156/*"es6-promise...*/]);
    FuseReactive_bundle::Observable7565aa71_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[154/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[157/*"observable-...*/]);
    FuseReactive_bundle::setTimeout06e90419_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[154/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[158/*"settimeout-...*/]);
}

static void FuseReactive_bundle_build(uType* type)
{
    ::STRINGS[154] = uString::Const("Fuse.Reactive");
    ::STRINGS[155] = uString::Const("diagnostics-4c71cb84.js");
    ::STRINGS[156] = uString::Const("es6-promise.min-a3069df9.js");
    ::STRINGS[157] = uString::Const("observable-66183501.js");
    ::STRINGS[158] = uString::Const("settimeout-cb0e3491.js");
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::Diagnosticsc55470d6_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::es6promisemin1fdd6b41_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::Observable7565aa71_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::setTimeout06e90419_, uFieldFlagsStatic);
    type->Reflection.SetFields(4,
        new uField("Diagnosticsc55470d6", 0),
        new uField("es6promisemin1fdd6b41", 1),
        new uField("Observable7565aa71", 2),
        new uField("setTimeout06e90419", 3));
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::Diagnosticsc55470d6_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::es6promisemin1fdd6b41_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::Observable7565aa71_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::setTimeout06e90419_;
// }

// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/Fuse.Text/0.45.5/.uno/package
// ------------------------------------------------------------------------------------------------
...
{
    FuseText_bundle::Renderer0b7f7722_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[159/*"uniform mat...*/], ::STRINGS[160/*"uniform vec...*/], 1, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"g"*/]));
}
...
{
    OutracksSimulatorClientUno_bundle::fight90e57290_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[161/*"Outracks.Si...*/]))->GetFile(::STRINGS[162/*"fight-15374...*/]);
}

static void OutracksSimulatorClientUno_bundle_build(uType* type)
{
    ::STRINGS[161] = uString::Const("Outracks.Simulator.Client.Uno");
    ::STRINGS[162] = uString::Const("fight-1537455b.png");
    type->SetFields(0,
...
// /Users/rolf.valstad/Library/Application Support/Fusetools/Packages/UnoCore/0.45.1/.uno/package
// ----------------------------------------------------------------------------------------------
...
{
    UnoCore_bundle::SdfFontShaderc4d110ba_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[163/*"uniform mat...*/], ::STRINGS[164/*"uniform flo...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[12/*"i"*/]));
    UnoCore_bundle::SpriteFontShader901b6a86_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[165/*"uniform mat...*/], ::STRINGS[166/*"uniform sam...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[10/*"g"*/]));
}
...
static void UnoCore_bundle_build(uType* type)
{
    ::STRINGS[163] = uString::Const("uniform mat4 d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[164] = uString::Const("uniform float e, f;\n"
        "\n"
        "uniform sampler2D i;\n"
        "\n"
        "varying vec2 g;\n"
    ...
    ::STRINGS[165] = uString::Const("uniform mat4 d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[166] = uString::Const("uniform sampler2D g;\n"
        "\n"
        "varying vec2 e;\n"
        "varying vec4 f;\n"
        "\n"
